...
//		gfrMsgReader := d.filesFromByteStream(pachClient, objReader, file, offset, size)
...
func (d *driver) filesFromByteStream(pachClient *client.APIClient, objReader io.Reader, file *pfs.File, offset, size int64) io.ReadCloser {
